...
const DOWNLOAD_URLS = {
  ...
  // Legacy build from v1.0.18 - works on macOS 10.11+ (El Capitan)
  macLegacy: `https://github.com/${GITHUB_REPO}/releases/download/v1.0.18/Virtual.Studio.Agent-legacy.zip`,
